DROP database IF EXISTS ecmall_pms;
create database ecmall_pms;
use  ecmall_pms;
...
(
  ...
  COLLATE = utf8_general_ci COMMENT ='ÊôÐÔ&ÊôÐÔ·Ö×é¹ØÁª';
...
(
  ...
  COLLATE = utf8_general_ci COMMENT ='商品三级分类';
...
(
    ...
    `brand_name`   varchar(255) CHARACTER SET utf8mb4  COLLATE utf8_general_ci DEFAULT NULL,
    `catalog_name` varchar(255) CHARACTER SET utf8mb4  COLLATE utf8_general_ci DEFAULT NULL,
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 6
  DEFAULT CHARSET = utf8
  COLLATE = utf8_general_ci COMMENT ='Æ·ÅÆ·ÖÀà¹ØÁª';
