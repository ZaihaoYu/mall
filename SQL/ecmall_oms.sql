DROP database IF EXISTS ecmall_oms;
create database ecmall_oms;
use  ecmall_oms;
...
(
    ...
    `order_sn`                char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '订单号',
...
(
    ...
    `order_sn`           char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'order_sn',
...
(
    ...
    `order_sn`        char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '订单编号',
...
(
    `id`               bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
    `order_sn`         char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '订单号（对外业务号）',
    `order_id`         bigint                                              DEFAULT NULL COMMENT '订单id',
